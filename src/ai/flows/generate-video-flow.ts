'use server';
/**
 * @fileOverview A text-to-video generation flow.
 *
    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a multilingual AI assistant capable of generating videos from text prompts in various languages, including Hmong.',
      },
    ],
  },
  async (input) => {
