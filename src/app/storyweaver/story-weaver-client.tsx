...
import { storyWeaverFlow } from '@/ai/flows/story-weaver-flow';
...
export default function StoryWeaverClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { story } = await storyWeaverFlow({ prompt: input });
    ...
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-3xl flex-col">
        <div className="flex items-center justify-between p-4 border-b border-border">
            <h1 className="text-xl font-bold">AI Story Weaver</h1>
